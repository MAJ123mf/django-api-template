...
# Login z Json in podporo tokenu Csrf
...
#            return JsonResponse({
#                "ok": True,
#                "message": f"The user {username} already is authenticated",
#                "data": [{'username': username}]
#            })
#
#        # ✅ Dodano: preberi JSON telo, če je prisotno
