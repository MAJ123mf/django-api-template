...
class BuildingsView(LoginRequiredMixin, BaseDjangoView):
    """
    ...
    def selectone(self, id):
        ...
        if len(l)==0:
            return JsonResponse({'ok':False, "message": f"The building id {id} does not exist", "data":[]}, status=404)
        b=l[0]
        d=model_to_dict(b)
        d['geom']=b.geom.wkt
    ...
    def insert(self, request):
        ...
        if exist:
            ...
            b.delete()
            return JsonResponse({'ok':False, 'message': f'The building intersects with {n} building/s'}, status=409)
    ...
    def update(self, request, id):
        ...
        if originalWkt is not None:
            ...
            return JsonResponse({'ok':False, 'message': 'Update. The geometry is mandartory', 'data':[]}, status=400)
    ...
    def insert2(self, request):
        ...
        return JsonResponse({'ok':True, 'message': "Building Inserted", 'data':[d]}, status=201)
